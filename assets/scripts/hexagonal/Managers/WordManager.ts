 ...
 * @author wheatup
 */
import { _decorator, Component, director, JsonAsset, resources } from 'cc';
...
@ccclass
export default class WordManager extends Component {
	...
	onLoad() {
		...
		director.emit(Events.LOAD_RESOURCE, { name: 'words' });

		this.words = this.jsonFile.json;
		director.emit(Events.LOADED_RESOURCE, { name: 'words', data: this.words });
		this.loaded = true;
